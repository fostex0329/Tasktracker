   ...
   return (
    <Collapsible open={isPeekOpen} onOpenChange={(next) => togglePeek(next)} className="w-full max-w-full">
      <div
        ...
        className="group flex w-full max-w-full cursor-pointer select-none flex-col gap-1 overflow-hidden rounded-md bg-transparent px-3 py-2 transition-colors hover:bg-muted/50 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
      >
        ...
        {timeLabel ? <div className="pl-10 text-xs text-muted-foreground break-words">{timeLabel}</div> : null}
      </div>
